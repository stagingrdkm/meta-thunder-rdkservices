...
SRC_URI += "file://0102-OMWAPPI-1119-cobalt-vault-implementation.patch"
...
EXTRA_OECMAKE_append = "${@oe.utils.version_less_or_equal('URSR_VERSION', '22', ' -DCOBALT_VAULT_ENABLED=OFF', ' -DCOBALT_VAULT_ENABLED=ON', d)}"
